...
bgrun wait <id> -t 30s                               # block until ready
...
| `bgrun wait <id> -t <duration>` | Block until ready (not a fixed sleep!) |
...
bgrun tail <id> --level error -n 5 # filtered lines
